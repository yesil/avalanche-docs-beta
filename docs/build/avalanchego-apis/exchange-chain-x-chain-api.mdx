...
Mint non-fungible tokens which were created with [`avm.createNFTAsset`](exchange-chain-x-chain-api.md#avm-createnftasset). More details can be found [here](../tutorials/smart-digital-assets/creating-a-nft-part-1.md).
